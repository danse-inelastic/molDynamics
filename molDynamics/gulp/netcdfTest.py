...
filename='Polarizations.nc'; numks=1; numAtoms=1; numDimensions=3
cdf = netcdf_file(filename,NC.WRITE|NC.CREATE|NC.TRUNC)
cdf.automode()
...
polarizations = cdf.def_var('polarizations', NC.DOUBLE, (k,modes,modes))
...
print polarizations[kIndex][modeIndex]
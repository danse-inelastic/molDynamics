...
"""
    ...
    :copyright: Copyright 2009 by Caltech.
...
class ClassDiagramGraph(object):
    """
...
class ClassDiagram(Directive):
    ...
    def run(self):
        ...
        try:
            graph = ClassDiagramGraph(class_names, env.currmodule)
...
def html_visit_class_diagram(self, node):
    """
    ...
    name = 'classdiagram%s' % graph_hash
    ...
    render_dot_html(self, node, dotcode, [], 'classdiagram', 'classdiagram')
    raise nodes.SkipNode


def latex_visit_class_diagram(self, node):
    """
    ...
    render_dot_latex(self, node, dotcode, [], 'classdiagram')
    raise nodes.SkipNode
...
def setup(app):
    ...
    app.add_node(
        class_diagram,
        latex=(latex_visit_class_diagram, None),
